...
{
    internal class DockThemePaneStrip : DockPaneStripBase
    {
        ...
        private static GraphicsPath GraphicsPath => DockThemeAutoHideStrip.GraphicsPath;
        ...
        public DockThemePaneStrip(DockPane pane)
            : base(pane)
        {
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                var tempX = x;
                var tab = Tabs[_mStartDisplayingTab] as TabVS2005;
