...
{
    internal class DockThemePaneCaption : DockPaneCaptionBase
    {
        private sealed class InertButton : InertButtonBase
        {
            ...
            public InertButton(DockThemePaneCaption dockPaneCaption, Bitmap image, Bitmap imageAutoHide)
            {
            ...
            private DockThemePaneCaption DockPaneCaption { get; }
        ...
        public DockThemePaneCaption(DockPane pane) : base(pane)
        {
            SuspendLayout();
